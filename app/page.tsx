...
export default function LandingPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-50 to-blue-100">
      <div className="bg-white px-16 py-8 rounded-lg shadow-lg w-full max-w-md">
        <Image
          src={logo}
          alt="Logo"
          width={120}
        ...
        <div className="py-6">
          <p className="text-xs text-center text-gray-600">
            Terimakasih telah bergabung dalam loyalty program kami.<br></br>
            Perbaharui data, klik "Validasi Member".
          </p>
        ...
        <div className="flex justify-between mt-5">
          <Image src={logo1} alt="Logo" width={80} height={200} />
          <Image src={logo2} alt="Logo" width={80} height={200} />
          <Image src={logo3} alt="Logo" width={80} height={200} />
          <Image src={logo4} alt="Logo" width={80} height={200} />
        </div>
      </div>
    </div>
  );
